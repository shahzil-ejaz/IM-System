...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'stock_transactions', 'product_batches', ['batch_id'], ['id'])
...
def downgrade() -> None:
    ...
    op.drop_constraint(None, 'stock_transactions', type_='foreignkey')
    op.create_foreign_key(op.f('stock_transactions_product_id_fkey'), 'stock_transactions', 'products', ['product_id'], ['id'])
